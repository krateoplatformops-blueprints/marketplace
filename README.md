...
|----------------|-------------------|---------------------|-----------------------|------------------------|
| template | [0.0.1](https://github.com/krateoplatformops-blueprints/template-blueprint/releases/tag/0.0.1) | portal | [https://github.com/krateoplatformops-blueprints/template-blueprint](https://github.com/krateoplatformops-blueprints/template-blueprint) | A Blueprint for Krateo Composable Portal Template page |
